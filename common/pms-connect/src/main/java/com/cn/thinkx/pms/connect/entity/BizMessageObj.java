...
public class BizMessageObj {
	...
	/*serviceName:packageNo:msgHead:dataHead:txnType:swtTxnDate:swtTxnTime:swtSettleDate:channel
	:swtBatchNo:swtFlowNo:recTxnDate:recTxnTime:recBatchNo:recFlowNo:issChannel:innerMerchantNo:innerShopNo
	:innerPosNo:track2:track3:cardNo:cvv2:expDate:accType:txnAmount:cardHolderFee:balance:pinQuiry:pinQuiryNew:pinTxn
	:pinTxnNew:respCode:authCode:referenceNo:oriSwtBatchNo:oriSwtFlowNo:oriRecBatchNo:oriRecFlowNo:oriTxnAmount
	:oriCardHolderFee:filePath:resv1:resv2:resv3:resv4:mac:resv5:resv6:resv7:otherdata*/
}
