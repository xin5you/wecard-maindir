package com.cn.thinkx.common.wecard.domain.page;
...
public class Pagination<E> extends AbstractPage<E> {
	...
	public String toString() {
		return String.format("Page[%d] of [%d] in total [%d] :%s", this.getPageNum(), this.getLastPageNum(),
				this.getTotalItemsCount(), items.toString());
	}
