...
public class NumberUtils {
	...
	*/    
	...
	public static void main(String[] args) {
		System.out.println(hideCardNo("6222620110035550426"));
		/*System.out.println(DateUtil.getCurrentDateTimeStr());
		System.out.println(new Double("0.01").intValue());
		System.out.println(Integer.parseInt("0.01"));*/
		/*int a = 2;
		int b = 4;
		System.out.println(mul(a, b));*/
//		System.out.println("6222989899655533".substring("6222989899655533".length()-4,"6222989899655533".length()));
//		try {
//			System.out.println(DateUtil.getDateTimeFromString("20180910121212"));
//		} catch (Exception e) {
//			// TODO Auto-generated catch block
//			e.printStackTrace();
//		}
//		String str = "卡密交易订单[Z1932856529]批量代付";
//		int strStartIndex = str.indexOf("[");  
//	    int strEndIndex = str.indexOf("]");  
//	    String result = str.substring(strStartIndex, strEndIndex).substring("[".length());  
//		
//		System.out.println(result);
//		double b = 500;
//		double c = 5;
//		int i = 0;
//		System.out.println(formatMoneydiv(b,c,i));
		...
		/*String jiaotong = "6222620110035550426";
		String xinyong = "6225768642945883";
		System.out.println(hideCardNo("6225768642"));
		String a = "100";
		String b = "5";
		System.out.println(sub(Double.parseDouble(a), Double.parseDouble(b)));
		double amt = 45.8;*/
		/*(new Double(amt)).intValue()+""
		NumberUtils.RMBCentToYuan()
		Integer.parseInt()*/
//		double a = mul("10000.3","0.04");
//		double b = 1;
//		double c = 0.04;
//		System.out.println(a);
//		System.out.println((new Double(c)).intValue()+"");
//		System.out.println(sub(a, b));
		...
		/*BigDecimal result = new BigDecimal(String.valueOf("0.1")).divide(new BigDecimal(String.valueOf("2")), 2, BigDecimal.ROUND_HALF_UP);
		double d = Double.parseDouble(result.toString());
		System.out.println(round(d));*/
//		System.out.println(sub(b,c));
//		String a = (new Double(c)).intValue()+"";
//		System.out.println();
