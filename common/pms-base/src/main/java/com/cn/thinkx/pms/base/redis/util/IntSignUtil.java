...
public class IntSignUtil {
	 ...
	 * @return
	 */
	public static String sign(SortedMap<String, String> items, String signKey) {
		...
		String key = RedisDictProperties.getInstance().getChannelKeyByCode(signKey);
