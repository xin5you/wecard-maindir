...
public class SignUtil {
	...
	@Value("${SIGNATURE_TIMEOUT}")
	private static String SIGNATURE_TIMEOUT;
	 ...
	 * @return
	 */
	public static String sign(SortedMap<String, String> items, String keys) {
	...
	public static void main(String[] args) {
		String str = "bankNo=6222620110037558799&productCode=444444&resellNum=1&userId=2018020213144200000941&key=1TnNrBksaAbed3SK1G5DrvZsIQDYFmOG";
		System.out.println(MD5Encode(str));
		
		/*String mobile = "15575311169";  
