package com.cn.thinkx.wecard.customer.module.base.ctrl;
...
public class BaseController {
	...
	/** 错误页面 网络异常 **/
	@RequestMapping(value = "/networkAnomaly")
	public ModelAndView networkAnomaly(HttpServletRequest request) {
		ModelAndView mv = new ModelAndView("common/networkAnomaly");
		return mv;
	}
	...
	public ModelAndView unValidated(HttpServletRequest request) {
		ModelAndView mv = new ModelAndView("common/unvalidated");
	...
	public ModelAndView fansAttentionTips(HttpServletRequest request) {
		ModelAndView mv = new ModelAndView("common/fansTips");
		mv.addObject("msg", MessageUtil.NO_AUTHORIZATION);
		return mv;
	}

	public void setPwdRSAKeyByopenId(HttpServletRequest request, ModelAndView mv, String openid)
