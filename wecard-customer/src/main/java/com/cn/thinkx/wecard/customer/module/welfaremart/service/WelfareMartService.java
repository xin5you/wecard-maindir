...
public interface WelfareMartService {
	 ...
	 * @return
	 */
	TransOrderReq buyCardCommit(HttpServletRequest request) throws Exception;
	 ...
	 * @return
	 */
	WelfaremartResellResp resellCommit(HttpServletRequest request, String userId) throws Exception;
