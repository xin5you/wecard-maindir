...
public class CustomeSurrondPreferentialCtrl extends BaseController {
    ...
    public @ResponseBody
    ShopListQueryITFResp surroundPreferentialList(HttpServletRequest request) {
    ...
    public @ResponseBody
    MchtSellingCardListQueryITFResp mchtSellingCardList(HttpServletRequest request) {
    ...
    public @ResponseBody
    MerchantInfoQueryITFResp viewMerchantInfo(HttpServletRequest request) {
