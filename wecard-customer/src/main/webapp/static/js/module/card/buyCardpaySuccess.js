$(function () {
	...
	var buyCardpaySuccess = {
        init: function () {
        	buyCardpaySuccess.initJsTicket();
        	//关闭页面
	      ...
	      //二维码买单
        	$('.qrCodeBtn').bind("click", function(){
        		//window.location.href = CONETXT_PATH + '/customer/user/qrCode.html';
        		this.href=CONETXT_PATH + '/customer/user/qrCode.html';
        		this.click();
	        });
        },
