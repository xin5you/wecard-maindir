...
public class ChannelSignUtil {
	...
	public static String sign(SortedMap<String, String> items,String channel) {
		...
		if (StringUtil.isNullOrEmpty(channel)) {
			key = JedisClusterUtils.getInstance().hget(Constants.REDIS_HASH_TABLE_TB_BASE_DICT_KV,"COMMON_SIGN_KEY");
		} else {
			key =JedisClusterUtils.getInstance().hget(Constants.REDIS_HASH_TABLE_TB_CHANNEL_SECURITY_INF_KV,channel);
		}
	...
	public static void main(String[] args) {
		...
		itemsMap.put("code", "SUCCESS");
		itemsMap.put("msg", "支付成功");
		itemsMap.put("nonce_str", "5996a24d");
		itemsMap.put("pay_type", "WXPAY");
		itemsMap.put("pp_trade_no", "17818081613a4146d");
		itemsMap.put("printType", "0");
		itemsMap.put("time_end", "20170818161637");
		itemsMap.put("total_fee", "1");
		itemsMap.put("transaction_id", "2c911e5a-7d8f-434a-813a-2030814e68e4");
//		
//	    "code": "SUCCESS",
//	    "msg": "支付成功",
//	    "nonce_str": "5996a24d",
