...
public class ExcelUtils<T> {
	 ...
	 * @return
	 */
	public HSSFWorkbook exportExcel(String title, String titlerow, String startTime, String endTime, String[] titlehead,
			String[] titleheadnum, String[] head, Collection<T> dataset, Class<?> c, Object obj) {
		...
		if (!StringUtil.isNullOrEmpty(titlerow)) {
