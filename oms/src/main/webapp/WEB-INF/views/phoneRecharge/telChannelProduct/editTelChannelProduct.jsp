					 ...
					 <div class="row-fluid">
					 	<div class="span12">
							<form action="${ctx }/channel/product/editTelProviderInfCommit.do" id="mainForm"  class="form-horizontal form_validation_tip" method="post" enctype="multipart/form-data" >
								<input type = "hidden" name=productId"" id="productId" value="${telCPInf.productId }"/>
								<h3 class="heading">编辑分销商充值产品信息</h3>
					     		<div class="control-group formSep">
					             	<label class="control-label">运营商产品名称</label>
						             <div class="controls">
		           			   	   			<input id="operName" name="operName" type="text" class="span6" value="${telCPInf.operName }"  maxlength="32"/>
					     		...
					     		<div class="control-group formSep">
						             ...
						             <div class="controls">
											<input type="text" class="span6" name="productAmt" id="productAmt" value="${telCPInf.productAmt }"  onkeyup="this.value=this.value.replace(/\D/g,'')" maxlength="12"/>
						                 	<span class="help-block"></span>
						             </div>
					     		</div>
					     		<div class="control-group formSep">
						             ...
						             <div class="controls">
											<input type="text" class="span6" name="productPrice" id="productPrice" value="${telCPInf.productPrice }" onkeyup="checkProductPrice(this)" maxlength="12"/>
						                 	<span class="help-block"></span>
						             </div>
					     		</div>
					     		<div class="control-group formSep">
                                ...
                                <div class="control-group">
                                     ...
                                     <div class="controls">
                                          <textarea  rows="4" class="span6" name="remarks" id = "remarks"  maxlength="256">${telCPInf.remarks }</textarea>
                                     </div>
                                </div>
						       <div class="control-group">
			                            <div class="controls">
			                            <sec:authorize access="hasRole('ROLE_TEL_CHANNEL_PRODUCT_EDITCOMMIT')">
