...
<head>
    ...
    <script src="${ctx}/resource/js/module/margin/merchantCashManage/mcerchantCashMarginConfirm.js"></script>
</head>
					 	...
					 	<div class="span12">
							<form id="mainForm" action="#" class="form-horizontal form_validation_tip" method="post">
								<input type="hidden" name="marginListId" id="marginListId" value="${merchantMargin.marginListId }">
								 <h3 class="heading">商户保证金-押款确认</h3>
...
<!-- 							     		</div> -->
								       ...
								       <div class="control-group ">
					                            <div class="controls">
					                            	<sec:authorize access="hasRole('ROLE_CASH_APPROVE_CONFIRMATION_ADDCOMMIT')">
					                            		<button class="btn btn-primary" type="button" id="submitApplyPassBtn" >确 认</button>
					                            	</sec:authorize>
