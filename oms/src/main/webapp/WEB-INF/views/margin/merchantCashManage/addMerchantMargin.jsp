...
<head>
    ...
    <script src="${ctx}/resource/js/module/margin/merchantCashManage/addMerchantMargin.js"></script>
</head>
                	...
                	<nav>
			            <div id="jCrumbs" class="breadCrumb module">
			                <ul>
			                    ...
			                    <li>保证金信息</li>
			                    <li><a href="${ctx }/margin/mchntCashManage/listMerchantMargin.do?chashId=${merchantCashManage.chashId }">保证金流水列表</a></li>
			                     <li>商户追加保证金-新增</li>
			                </ul>
			            </div>
			        </nav>
					 <div class="row-fluid">
					 	<div class="span12">
							<form id="mainForm" action="#" class="form-horizontal form_validation_tip" method="post">
								<input type="hidden" name="chashId" id="chashId" value="${merchantCashManage.chashId }">
								 <h3 class="heading">商户追加保证金-新增</h3>
...
<!-- 							             <div class="controls"> -->
<!-- 							                  <select id="approveStat" name="approveStat" class="input-135"> -->
...
<!-- 							     		</div> -->
							             ...
							             <div class="controls">
							                 <input type="text" class="span6" id="getQuota" name="getQuota"  value="${merchantCashManage.getQuota/100}" disabled="true"/>
							     		...
							     		<div class="control-group">
								             ...
								             <div class="controls">
								                 <input type="text" class="span6" id="rechargeFaceAmt" name="rechargeFaceAmt" value="${merchantCashManage.rechargeFaceAmt/100}" disabled="true"/>
								             </div>
							     		</div>
							     		<div class="control-group">
								             <label class="control-label">保证金追加金额</label>
								             <div class="controls">
								                 <input type="text" class="span6" id="addMortgageAmt" name="addMortgageAmt"/>
								             </div>
							     		</div>
							     		<div class="control-group">
								             <label class="control-label">追加获取总额度</label>
								             <div class="controls">
								                 <input type="text" class="span6" id="addGetQuota" name="addGetQuota"/>
								                 <span class="help-block">例如：当前追加金额是10000元,商户给12000的额度，当前输入值是12000</span>
								             </div>
							     		</div>
								       <div class="control-group ">
					                            <div class="controls">
					                            	<sec:authorize access="hasRole('ROLE_CASH_MARGIN_ADDCOMMIT')">
