...
<html>
	<head>
		...
		<script src="${ctx}/resource/js/module/trans/cardTrans/listCardTrans.js"></script>
	</head>
	<body>
		...
		<div id="contentwrapper">
			<div class="main_content">
				...
				<form id="searchForm" action="${ctx }/trans/cardTransInf/listTrans.do" class="form-inline" method="post">
					<h3 class="heading">通卡交易明细列表</h3>
					<div class="row-fluid">
						<div class="span12">
