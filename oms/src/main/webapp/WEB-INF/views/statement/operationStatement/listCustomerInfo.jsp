...
<head>
    ...
    <script src="${ctx}/resource/js/module/statement/operationStatement/listCustomerInfo.js"></script>
</head>
<body>
                ...
                <div class="main_content">
                	<nav>
			            <div id="jCrumbs" class="breadCrumb module">
			                <ul>
			                    ...
			                    <li>报表管理</li>
			                    <li>运营报表</li>
			                    <li><a href="${ctx }/statement/operationStatement/listCustomerInfo.do">客户数据列表</a></li>
			                </ul>
			            </div>
			        </nav>
					<form id="searchForm" action="${ctx }/statement/operationStatement/listCustomerInfo.do" class="form-inline" method="post">
						<input type="hidden" id="operStatus"  value="${operStatus }"/>
						<h3 class="heading">客户数据列表</h3>
					...
					<br/>    
				         <table class="table table-striped table-bordered dTableR table-hover" id="dt_gal" >
				             ...
				             <c:if test="${cus!=null }">
					             <tr>
	                               <td>${cus.attentionCount }</td>
	                               <td>${cus.openAccountCount }</td>
	                               <td>${cus.openCardCount }</td>
	                             </tr>
	                          </c:if>
				             </tbody>
				         </table>
