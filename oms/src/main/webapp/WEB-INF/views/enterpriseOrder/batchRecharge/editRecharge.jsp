...
<head>
    ...
    <script src="${ctx}/resource/js/module/enterpriseOrder/batchRecharge/editRecharge.js"></script>
</head>
<body>
	   <%@ include file="/WEB-INF/views/common/navbar.jsp"%>
	    ...
	    <div id="editAddRechargeModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
