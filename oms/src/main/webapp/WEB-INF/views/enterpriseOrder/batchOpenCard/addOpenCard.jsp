...
<head>
    ...
    <script src="${ctx}/resource/js/module/enterpriseOrder/batchOpenCard/addOpenCard.js"></script>
	   ...
	   <%@ include file="/WEB-INF/views/common/navbar.jsp"%>
            <div id="contentwrapper">
                <div class="main_content">
					...
					<form id="pageMainForm" action="${ctx }/enterpriseOrder/batchOpenCard/intoAddOpenCard.do" class="form-inline form_validation_tip" method="post">
						...
						<div class="row-fluid" >
							 <div class="span12">
		                       	...
		                       	<div class="pull-right">
                                    <button class="btn btn-primary btn-card-list" type="button">文件导入</button>
						...
						<div class="control-group formSep">
				         ...
				         <div>
				         <button class="btn btn-primary btn-addCard" type="button">添加</button>
				         </div>
				         <br/>
				      ...
				      <br/>
				      <sec:authorize access="hasRole('ROLE_BATCH_OPEN_CARD_ADDCOMMIT')">
	    ...
	    <div id="CardListModal" class="modal hide fade" tabindex="-1" role="dialog" aria-hidden="true">
	    ...
	    <div id="addCardModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <form class="form-horizontal">
                <div class="modal-header">
                    <button class="close" data-dismiss="modal">&times;</button>
                    <h3 id="commodityInfModal_h">添加订单</h3>
                </div>
                <div class="modal-body">
