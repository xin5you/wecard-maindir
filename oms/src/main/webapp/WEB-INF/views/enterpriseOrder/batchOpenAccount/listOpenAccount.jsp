...
<head>
    ...
    <script src="${ctx}/resource/js/module/enterpriseOrder/bathOpenAccount/listOpenAccount.js"></script>
</head>
<body>
	   <%@ include file="/WEB-INF/views/common/navbar.jsp"%>
            <div id="contentwrapper">
                <div class="main_content">
					...
					<form id="searchForm" action="${ctx }/enterpriseOrder/batchOpenAccount/listOpenAccount.do" class="form-inline" method="post">
				         ...
				         <table class="table table-striped table-bordered dTableR table-hover" id="dt_gal" >
				             ...
				             <c:forEach var="entity" items="${pageInfo.list}" varStatus="st">
				                 <tr>
                                   ...
                                   <sec:authorize access="hasRole('ROLE_BATCH_OPEN_ACCOUNT_ORDERCOMMIT')">
                                   ...
                                   <sec:authorize access="hasRole('ROLE_BATCH_OPEN_ACCOUNT_ORDERAGAINCOMMIT')">
