...
<head>
    ...
    <script src="${ctx}/resource/js/module/enterpriseOrder/bathOpenAccount/editOpenAccount.js"></script>
</head>
<body>
	   <%@ include file="/WEB-INF/views/common/navbar.jsp"%>
            <div id="contentwrapper">
                <div class="main_content">
					...
					<form id="mainForm" action="${ctx }/enterpriseOrder/batchOpenAccount/intoEditOpenAccount.do?orderId=${order.orderId}" class="form-inline" method="post">
				      ...
				      <br/>
                      <a href="${ctx }/enterpriseOrder/batchOpenAccount/listOpenAccount.do"><button class="btn btn-primary" type="button">返回</button></a>
			   </div>
	    </div>
	    ...
	    <div id="editAddAccountModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-footer" style="text-align: center;">
                <sec:authorize access="hasRole('ROLE_BATCH_OPEN_ACCOUNT_ORDERLISTCOMMIT')">
