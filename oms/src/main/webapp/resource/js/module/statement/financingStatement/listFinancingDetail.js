$(document).ready(function() {
	listFinancingDetail.init();
})

var listFinancingDetail = {
	init : function() {
		listFinancingDetail.initEvent();
	...
	initEvent:function(){
		...
		$('#mercahnt_select').change(listFinancingDetail.getShopInfList);
		$('.btn-search').on('click', listFinancingDetail.searchData);
		$('.btn-reset').on('click', listFinancingDetail.searchReset);
		$('.btn-upload').on('click',listFinancingDetail.uploadFinancingDetail);
	},
	searchData: function(){
	...
	searchReset: function(){
		location = Helper.getRootPath() + '/statement/financingStatement/listFinancingDetail.do';
	},
	uploadFinancingDetail:function(){
		var mchntCode = $('#mercahnt_select').val();
		var shopCode = $('#shopCode').val();
		var sd = $('#startTime').val();
		var ed = $('#endTime').val();
		...
		location = Helper.getRootPath() + '/statement/financingStatement/uploadFinancingDetail.do?mchntCode='+mchntCode+'&shopCode='+shopCode+'&startTime='+sd+'&endTime='+ed;
	},
