...
$(document).ready(function () {
    addMerchantManagerTmp.init();
})

var addMerchantManagerTmp = {

    init: function () {
    	addMerchantManagerTmp.initTip();
		$('#mercahnt_select').change(addMerchantManagerTmp.getShopInfList);
    },
    ...
    initTip: function () {
        var ttip_validator = $('.form_validation_tip').validate({
            ...
            submitHandler: function(form) {
            	addMerchantManagerTmp.addMerchantManagerTmpCommit();
            },
    ...
    addMerchantManagerTmpCommit:function(){
    	var mchntId=$('#mercahnt_select').val();
		...
		$.ajax({
            type: 'POST',
            url: Helper.getRootPath() + '/merchant/managerTmp/addMerchantManagerTmpCommit.do',
            data: {
            		"mchntId" :mchntId,
            		"shopId": shopId,
            		"name":name,
