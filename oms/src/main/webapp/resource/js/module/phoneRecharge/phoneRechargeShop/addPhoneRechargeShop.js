$(document).ready(function () {
    addPhoneRechargeShop.init();
})

var addPhoneRechargeShop = {

    init: function () {
    	addPhoneRechargeShop.initEvent();
    },
	initEvent:function(){
		$('#addSubmitBtn').on('click', addPhoneRechargeShop.addPhoneRechargeShopCommit);
		$('#shopType').on('change',addPhoneRechargeShop.getShopUnit);
	},
    addPhoneRechargeShopCommit:function(){
