$(document).ready(function () {
    editTelProviderInf.init();
})

var editTelProviderInf = {

    init: function () {
    	editTelProviderInf.initTip();
    },
    ...
    initTip: function () {
        var ttip_validator = $('.form_validation_tip').validate({
            ...
            submitHandler: function(form) {
            	editTelProviderInf.editTelProviderInfCommit();
            },
            success: $.noop // Odd workaround for errorPlacement not firing!
        });
    },
    editTelProviderInfCommit:function(){
		...
		$.ajax({
            type: 'POST',
            url: Helper.getRootPath() + '/provider/providerInf/editTelProviderInfCommit.do',
            data: {
            ...
            success: function(data){
                ...
                if(data.status) {
					location.href=Helper.getRootPath() + '/provider/providerInf/listTelProviderInf.do?operStatus=2';
                }else{
