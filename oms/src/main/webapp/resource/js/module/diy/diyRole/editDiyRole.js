    ...
    initTip: function () {
        var ttip_validator = $('.form_validation_tip').validate({
            ...
            submitHandler: function(form) {
				...
				editDiyRole.editDiyRoleCommit();
            },
            success: $.noop // Odd workaround for errorPlacement not firing!
        });
    },
    editDiyRoleCommit:function(){
    	var roleName=$("#roleName").val();
    	var seq=$("#seq").val();
    	var description=$("#description").val();
    	var diyRoleId=$("#diyRoleId").val();
		...
		$.ajax({
            type: 'POST',
            url: Helper.getRootPath() + '/diy/diyRole/editDiyRoleCommit.do',
            data: {
            		"id":diyRoleId,
            		"roleName" :roleName,
            		"seq": seq,
