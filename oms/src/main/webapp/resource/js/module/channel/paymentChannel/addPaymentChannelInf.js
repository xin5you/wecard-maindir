...
$(document).ready(function () {
	addPaymentChannelInf.init();
})

var addPaymentChannelInf = {
	init:function(){
		addPaymentChannelInf.initTip();
		$('.btn-search').on('click', addPaymentChannelInf.searchReset);
	},
    initTip: function () {
        var ttip_validator = $('.form_validation_tip').validate({
            ...
            submitHandler: function(form) {
            	addPaymentChannelInf.addPaymentChannelInfCommit();
            },
	...
	addPaymentChannelInfCommit:function(){
		...
		$.ajax({
            type: 'POST',
            url: Helper.getRootPath() + '/channel/paymentChannel/addPaymentChannelInfCommit.do',
            data: {
            		'channelNo': channelNo,
