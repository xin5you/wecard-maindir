...
$(document).ready(function () {
	addPaymentChannelApiInf.init();
})

var addPaymentChannelApiInf = {
	init:function(){
		addPaymentChannelApiInf.initTip();
		$('.btn-search').on('click', addPaymentChannelApiInf.searchReset);
	},
    initTip: function () {
        var ttip_validator = $('.form_validation_tip').validate({
            ...
            submitHandler: function(form) {
            	addPaymentChannelApiInf.addPaymentChannelApiInfCommit();
            },
    ...
    addPaymentChannelApiInfCommit:function(){
		var name = $('#name').val();
		var url = $('#url').val();
		...
		$.ajax({
            type: 'POST',
            url: Helper.getRootPath() + '/channel/paymentChannelApi/addPaymentChannelApiInfCommit.do',
            data: {
            		'channelId': channelId,
            		'name' :name,
            		'url' :url,
