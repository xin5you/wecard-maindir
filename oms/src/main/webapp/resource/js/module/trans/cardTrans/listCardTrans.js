...
var listTrans = {
	...
	searchReset: function(){
		location = Helper.getRootPath() + '/trans/cardTransInf/listTrans.do';
	},
	...
	uploadListTrans:function(){
		...
		if (queryType == 'his') {
			...
			location = Helper.getRootPath() + '/trans/cardTransInf/uploadListTrans.do?mchntCode='+mchntCode+'&mchntName='+mchntName+'&shopCode='+shopCode+'&shopName='+shopName+'&queryType='+queryType+'&transType='+transType+'&userName='+userName+'&channelCode='+channelCode+'&startTime='+sd+'&endTime='+ed;
		} else {
			location = Helper.getRootPath() + '/trans/cardTransInf/uploadListTrans.do?mchntCode='+mchntCode+'&mchntName='+mchntName+'&shopCode='+shopCode+'&shopName='+shopName+'&queryType='+queryType+'&transType='+transType+'&userName='+userName+'&channelCode='+channelCode;
		}
