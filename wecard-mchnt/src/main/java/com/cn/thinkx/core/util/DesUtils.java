...
public class DesUtils {
	...
	public static void main(String[] args) {
		...
		String str = DesUtils.strEnc(data, key1);
		System.out.println(str);
		String dec = DesUtils.strDec(str, key1);
	 ...
	 */
	public static String strDec(String data, String firstKey) {
		return strDec(data, firstKey, null, null);
	}

	private static String strDec(String data, String firstKey, String secondKey, String thirdKey) {
		int leng = data.length();
		String decStr = "";
		List<?> firstKeyBt = null, secondKeyBt = null, thirdKeyBt = null;
		int firstLength = 0, secondLength = 0, thirdLength = 0;
