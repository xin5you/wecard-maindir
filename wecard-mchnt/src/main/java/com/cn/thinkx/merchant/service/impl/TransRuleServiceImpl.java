...
import com.cn.thinkx.merchant.mapper.RuleDeclareDao;
import com.cn.thinkx.merchant.mapper.RuleFactorDao;
import com.cn.thinkx.merchant.mapper.RuleTemplateDao;
import com.cn.thinkx.merchant.mapper.RuleTypeDao;
import com.cn.thinkx.merchant.mapper.TransRuleDao;
import com.cn.thinkx.merchant.service.TransRuleService;
...
public class TransRuleServiceImpl implements TransRuleService {
	...
	public int insertRechargePresentRule(String ruleTypeCode,TransRule transRule,List<RuleFactor> factorList){
		...
		ruleDeclare.setDataStat(Constants.DataStatEnum.TRUE_STATUS.getCode());
	...
	public TransRuleDeclare getTransRuleDeclareByRuleId(String ruleId){
		...
		if(tr !=null){
			...
			if(Constants.RuleTypeEnum.RULETYPE_1000.getCode().equals(tr.getRuleType())){
				tr.setRuleParam(NumberUtils.formatMoney(tr.getRuleParam()));
			}
			if(Constants.RuleTypeEnum.RULETYPE_2000.getCode().equals(tr.getRuleType())){
